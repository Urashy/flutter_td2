...
class OpenWeatherMapApi {
  ...
  Future<Iterable<Location>> searchLocations(
    ...
    if (response.statusCode == HttpStatus.ok) {
      // Décoder le JSON en une liste de Maps
      final List<dynamic> jsonData = json.decode(response.body);

      // Convertir chaque élément de la liste en un objet Location
      return jsonData.map((locationJson) => Location.fromJson(locationJson));
    }
